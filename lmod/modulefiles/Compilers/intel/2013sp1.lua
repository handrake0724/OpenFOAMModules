...
local intel_prefix="/opt/HPC/Compilers/intel"
...
setenv("MPM_LAUNCHER", pathJoin(intelxe_prefix, "debugger_2013/mpm/mic/bin/start_mpm.sh"))
setenv("F77", "ifort")
setenv("F90", "ifort")

prepend_path("PATH", pathJoin(intelxe_prefix, "debugger_2013/gdb/intel64_mic/bin"))
...
prepend_path("LD_LIBRARY_PATH", pathJoin(intelxe_prefix, "debugger_2013/libipt/intel64/lib"))
...
prepend_path("NLSPATH", pathJoin(icc_prefix, "debugger_2013/gdb/intel64_mic/share/locale/%l_%t/%N"))
prepend_path("NLSPATH", pathJoin(icc_prefix, "debugger_2013/gdb/intel64/share/locale/%l_%t/%N"))
...
prepend_path("GDB_CROSS", pathJoin(intelxe_prefix, "debugger_2013/gdb/intel64_mic/bin/gdb-mic"))
prepend_path("GDBSERVER_MIC", pathJoin(intelxe_prefix, "debugger_2013/gdb/targets/mic/bin/gdbserver"))
prepend_path("INFOPATH", pathJoin(intelxe_prefix, "documentation_2013/en/debugger/gdb-ia/info"))
prepend_path("INFOPATH", pathJoin(intelxe_prefix, "documentation_2013/en/debugger/gdb-mic/info"))
prepend_path("INFOPATH", pathJoin(intelxe_prefix, "documentation_2013/en/debugger/gdb-igfx/info"))
prepend_path("INTEL_PYTHONHOME", pathJoin(intelxe_prefix, "debugger_2013/python/intel64"))
prepend_path("INTEL_LICENSE_FILE", pathJoin(intelxe_prefix, "licenses"))

prepend_path("MANPATH", pathJoin(intelxe_prefix, "documentation_2013/en/debugger/gdb-ia/man/"))
prepend_path("MANPATH", pathJoin(intelxe_prefix, "documentation_2013/en/debugger/gdb-mic/man/"))
prepend_path("MANPATH", pathJoin(intelxe_prefix, "documentation_2013/en/debugger/gdb-igfx/man/"))
