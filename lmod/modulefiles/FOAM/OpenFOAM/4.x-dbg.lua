...
whatis("Version: 4.x")
whatis("Description: OpenFOAM is the leading free, open source software for computational dynamcis (CFD), owned by the OpenFOAM Foundation and developed by a team of contributors, most notably from CFD Direct.")
